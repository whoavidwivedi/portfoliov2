...
const Skills: React.FC = () => {
  return (
    <section id="skills" className="py-16 md:py-24 bg-white dark:bg-stone-900 relative border-b-2 border-ink dark:border-white transition-colors">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-12 gap-8 md:gap-12">
          <div className="md:col-span-4">
            <motion.h2
              className="text-4xl md:text-6xl font-black font-display text-ink dark:text-white mb-6"
