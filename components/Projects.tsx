...
const Projects: React.FC = () => {
  return (
    <section id="projects" className="py-24 bg-paper dark:bg-dark-paper relative transition-colors">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
          <div>
            ...
            <motion.h2 
              className="text-4xl md:text-7xl font-black font-display text-ink dark:text-white uppercase"
        ...
        <motion.div 
            ...
            viewport={{ once: true }}
            className="w-full min-h-[300px] md:min-h-[400px] flex flex-col items-center justify-center bg-stone-100 dark:bg-stone-800 border-2 border-dashed border-ink dark:border-white neo-shadow bg-stripes relative overflow-hidden p-6 md:p-8"
        >
            {/* Caution Tape Effect */}
            <div className="absolute top-5 -left-12 sm:top-10 sm:-left-10 w-64 h-8 md:h-12 bg-yellow-400 text-black font-black flex items-center justify-center transform -rotate-45 border-y-2 md:border-y-4 border-black z-10 opacity-90 shadow-lg text-xs md:text-base">
                UNDER CONSTRUCTION
            </div>
            
             <div className="absolute bottom-5 -right-12 sm:bottom-10 sm:-right-10 w-64 h-8 md:h-12 bg-yellow-400 text-black font-black flex items-center justify-center transform -rotate-45 border-y-2 md:border-y-4 border-black z-10 opacity-90 shadow-lg text-xs md:text-base">
                UNDER CONSTRUCTION
            </div>
