        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
            <div className="md:col-span-1 space-y-6">
               <div className="p-6 bg-orange-50 dark:bg-stone-800 border-2 border-ink dark:border-white neo-shadow text-center md:text-left transform hover:rotate-2 transition-transform">
                  ...
                  <a href="mailto:avi@example.com" className="text-ink dark:text-stone-300 hover:text-orange-600 dark:hover:text-orange-400 font-medium underline decoration-2">avi@example.com</a>
               </div>
            ...
            <form className="md:col-span-2 bg-paper dark:bg-dark-paper p-8 border-2 border-ink dark:border-white neo-shadow relative">
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full bg-white dark:bg-stone-800 p-3 neo-input font-medium text-ink dark:text-white dark:border-stone-500" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-black text-ink dark:text-white uppercase tracking-wider">Email</label>
                  <input type="email" className="w-full bg-white dark:bg-stone-800 p-3 neo-input font-medium text-ink dark:text-white dark:border-stone-500" placeholder="john@company.com" />
                </div>
              </div>
              <div className="space-y-2 mb-8">
                 <label className="text-sm font-black text-ink dark:text-white uppercase tracking-wider">Message</label>
                 <textarea rows={4} className="w-full bg-white dark:bg-stone-800 p-3 neo-input font-medium text-ink dark:text-white resize-none dark:border-stone-500" placeholder="Tell me about your project..."></textarea>
              </div>
              <button className="w-full py-4 bg-orange-500 text-white font-black text-lg border-2 border-ink dark:border-white neo-shadow hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all flex items-center justify-center gap-2">
