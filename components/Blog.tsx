...
const Blog: React.FC = () => {
  return (
    <section id="blog" className="py-16 md:py-24 bg-orange-50 dark:bg-stone-900 border-t-2 border-ink dark:border-white relative overflow-hidden transition-colors">
      {/* Background Text Texture */}
      <div className="absolute top-10 -right-10 md:right-0 text-[80px] md:text-[200px] font-black font-display text-white dark:text-stone-800 opacity-60 dark:opacity-20 select-none pointer-events-none z-0 leading-none">
        BLOG
      </div>
