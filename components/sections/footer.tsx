...
export function Footer() {
  return (
    <footer className="border-t border-border/50 pt-10 pb-16 text-xs text-muted-foreground/80">
            ...
            <TooltipTrigger
              render={
                <Button
                  ...
                  size="icon"
                  nativeButton={false}
                  className="size-8 rounded-lg text-foreground/80 border-border/60 hover:bg-muted/60 active:scale-[0.96] transition-all cursor-pointer [&_svg:not([class*='size-'])]:size-3.5"
                  render={
                    <a
