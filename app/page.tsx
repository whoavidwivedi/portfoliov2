      ...
      >
        <div className="mb-20">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground">
            I write code, teach people, and build in public. Built tools to help students crack
            interviews at takeUforward. Previously taught programming at BrightCHAMPS, working
            with C, C++, Python, and web development.
          </p>
            ...
            {[
              {
                ...
                desc: "Built tools to help students prepare for coding interviews.",
              },
              {
                title: "Coding Educator @ BrightCHAMPS",
                period: "2024 — 2025",
                desc: "Taught C, C++, Python, and web dev to students aged 10–18.",
              },
            ].map((item) => (
              <div key={item.title}>
            ...
            {[
              ...
              <div key={p.name}>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-base font-medium underline underline-offset-2 transition-colors hover:text-orange-500"
                >
                  {p.name}
                </a>
